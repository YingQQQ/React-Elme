...
//   on(node, event, handler, options);
//   return {
//     remove() {
//       off(node, event, handler, options);
//     },
//   };
// }
...
class SwipeableViews extends Component {
  ...
  componentDidMount() {
    ...
    this.transitionListener = listen(
      this.containerNode,
      'transitionend',
      (event) => {
